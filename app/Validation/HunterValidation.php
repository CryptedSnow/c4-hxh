...
class HunterValidation
{
    ...
    public array $hunter_store = [
        ...
        'tipo_hunter_id' => 'required|integer|exists[tipos_hunters,id]',
        'tipo_nen_id' => 'required|integer|exists[tipos_nens,id]',
        'tipo_sangue_id' => 'required|integer|exists[tipos_sanguineos,id]',
