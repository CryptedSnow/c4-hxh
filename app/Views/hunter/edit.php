...
<div class="card-body">
    ...
    <form method="POST" action="<?= site_url('hunter/update/'.$hunters['id']) ?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="idade_hunter" placeholder="Digite a idade do Hunter" value="<?php echo $hunters['idade_hunter']; ?>" onkeypress="$(this).mask('00', {reverse: true});">
            <?php echo session()->getFlashdata('errors')["idade_hunter"] ?? "";?>
        </div>
        <br>
        <div class="form-group">
            <label for="altura_hunter">Altura:</label>
            <input type="text" class="form-control" name="altura_hunter" placeholder="Digite a altura do Hunter" value="<?php echo $hunters['altura_hunter']; ?>" onkeypress="$(this).mask('0.00', {reverse: true});">
            <?php echo session()->getFlashdata('errors')["altura_hunter"] ?? "";?>
        </div>
        <br>
        <div class="form-group">
            <label for="peso_hunter">Peso:</label>
            <input type="text" class="form-control" name="peso_hunter" placeholder="Digite o peso do Hunter" value="<?php echo $hunters['peso_hunter']; ?>" onkeypress="$(this).mask('000.00', {reverse: true});">
