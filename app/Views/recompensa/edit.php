...
<div class="card-body">
    ...
    <form method="POST" action="<?= site_url('recompensa/update/'.$recompensas['id']) ?>">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="valor_recompensa" placeholder="Digite o valor da recompensa" value="<?php echo $recompensas['valor_recompensa']; ?>" onkeypress="$(this).mask('0000000.00', {reverse: true});">
